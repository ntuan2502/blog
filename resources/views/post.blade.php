...
<div class="bradcam_area" style="background-image: url('{{asset($post->cover)}}')">
   <div class="container">
      <div class="row">
         <div class="col-xl-12">
         ...
         <div class="col-lg-12 posts-list">
            <div class="single-post">
               <!-- <div class="feature-img">
                  <img class="img-fluid" src="{{asset('public/homepage/img/blog/single_blog_1.png')}}" alt="">
               </div> -->
               ...
               <div class="navigation-area">
                  <div class="row">
                     <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                        <div class="thumb">
                           <a href="#">
                              <img class="img-fluid" src="{{asset('public/homepage/img/post/preview.png')}}" alt="">
                           </a>
                        </div>
                        <div class="arrow">
                           <a href="#">
                     ...
                     <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                        ...
                        <div class="thumb">
                           <a href="#">
                              <img class="img-fluid" src="{{asset('public/homepage/img/post/next.png')}}" alt="">
                           </a>
                        </div>
                     </div>
                  </div>
            ...
            <div class="blog-author">
               <div class="media align-items-center">
                  <img src="{{asset('public/homepage/img/blog/author.png')}}" alt="">
...
@endsection
@section('footer')
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v5.0&appId=1107076142812425&autoLogAppEvents=1"></script>
<script>
